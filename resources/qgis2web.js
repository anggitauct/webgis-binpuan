...
map.getView().fit([10576431.935378, -1018381.991055, 13284400.508332, 677753.827502], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sebaran Kegiatan Direktorat Pembinaan Kemampuan</h2>';
        return titleElement;
    })(),
