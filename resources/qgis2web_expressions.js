...
function exp_DirektoratPembinaankemampuan_7rule0_eval_expression(context) {
    // Unit = 'Pengembangan Sistem Operasi'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Unit')  == 'Pengembangan Sistem Operasi');
    } else {
        return (feature.get('Unit')  == 'Pengembangan Sistem Operasi');
    }
}
...
function exp_DirektoratPembinaankemampuan_7rule1_eval_expression(context) {
    // Unit = 'Subdirektorat Pelatihan'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Unit')  == 'Subdirektorat Pelatihan');
    } else {
        return (feature.get('Unit')  == 'Subdirektorat Pelatihan');
    }
}
...
function exp_DirektoratPembinaankemampuan_7rule2_eval_expression(context) {
    // Unit = 'Subdirektorat Penggunaan Kekuatan'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Unit')  == 'Subdirektorat Penggunaan Kekuatan');
    } else {
        return (feature.get('Unit')  == 'Subdirektorat Penggunaan Kekuatan');
    }
}